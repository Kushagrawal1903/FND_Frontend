      ...
      <div className="w-full max-w-[400px] flex flex-col items-center relative z-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-stack-lg">
            ...
            <div className="flex flex-col gap-stack-xs">
              <div className="flex justify-between items-center">
                ...
                <span className="font-label-sm text-label-sm text-primary opacity-50 cursor-not-allowed">
                  Forgot Password?
                </span>
              </div>
              <div className="relative">
        ...
        <div className="mt-stack-lg flex flex-col items-center gap-stack-sm">
          <p className="font-body-md text-body-md text-on-surface-variant">
            ...
            <Link className="font-label-md text-label-md text-primary hover:underline transition-all" to="/register">
              Create an Account
            </Link>
          </p>
        </div>
